...
private:
    ...
    unordered_map<int, vector<int>> destTimestamps;  // destination -> timestamps
...
public:
    ...
    bool addPacket(int source, int destination, int timestamp) {
        ...
        // keep timestamps sorted for binary search
    ...
    vector<int> forwardPacket() {
        ...
        // remove this timestamp from destTimestamps
    ...
    int getCount(int destination, int startTime, int endTime) {
        ...
        int leftIdx = lower_bound(vec.begin(), vec.end(), startTime) - vec.begin(); // first >= startTime
        int rightIdx = upper_bound(vec.begin(), vec.end(), endTime) - vec.begin();  // first > endTime
